    ...
    return (
      <React.Fragment>
        <div className="page-top-line">
          ...
          >
            This page is only available in <a className="text-white fw-bold" rel="noreferrer noopener" href="https://flatlogic.com/admin-dashboards/sing-app-react-node-js" target="_blank"> with Node.js</a> integration!
          </Alert>
        </div>
        <ChangePasswordForm
