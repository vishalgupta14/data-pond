    ...
    return (
      <React.Fragment>
          <div className="page-top-line">
            ...
            >
              This page is only available in <a className="text-white font-weight-bold" rel="noreferrer noopener" href="https://flatlogic.com/templates/sing-app-react-node-js" target="_blank"> with NodeJS/.NET</a> integration!
            </Alert>
          </div>
