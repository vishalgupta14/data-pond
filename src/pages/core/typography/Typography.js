          ...
          <div className="widget-padding-md w-100 h-100 text-start border rounded">
            <blockquote className="blockquote">
              <p>Don&apos;t get set into one form, adapt it and build your own, and let
                  it grow, be like Data. Empty your mind, be formless, shapeless — like Data.
                  Now you put Data in a cup, it becomes the cup; You put Data into a bottle it
                  becomes the bottle; You put it in a teapot it becomes the teapot. Now Data can
                  flow or it can crash. Be Data, my friend.</p>
